# -*- coding: utf-8 -*-
""""Transformer-Torch"copy

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QrwcLLvk0fOzgh4tejjqb2KOf9IGjlBG
"""
...
greedy_dec_input = greedy_decoder(model, enc_inputs[0].view(1, -1).to(device), start_symbol=tgt_vocab["S"])
predict, _, _, _ = model(enc_inputs[0].view(1, -1).to(device), greedy_dec_input)
